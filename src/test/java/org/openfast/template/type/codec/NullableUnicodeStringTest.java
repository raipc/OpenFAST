...
public class NullableUnicodeStringTest extends OpenFastTestCase {
    public void testEncodeDecode() throws Exception {
        assertEncodeDecode(string("Yo"), "10000011 01011001 01101111", ValuesCodecs.NULLABLE_UNICODE);
        assertEncodeDecode(string("\u00f1"), "10000011 11000011 10110001", ValuesCodecs.NULLABLE_UNICODE);
        assertEncodeDecode(string("A\u00ea\u00f1\u00fcC"),
                "10001001 01000001 11000011 10101010 11000011 10110001 11000011 10111100 01000011",
                ValuesCodecs.NULLABLE_UNICODE);
        assertEncodeDecode(null, "10000000", ValuesCodecs.NULLABLE_UNICODE);
    }
